...
public interface IWXRenderListener {
  ...
  /**
   * If {@link cn.xxzhushou.xmod.wxui.common.WXRenderStrategy#APPEND_ASYNC} is applied, this method
   * will be invoked when the rendering of first view is finish.
   * If {@link cn.xxzhushou.xmod.wxui.common.WXRenderStrategy#APPEND_ONCE} is applied, this method will
