...
import cn.xxzhushou.xmod.wxui.dom.CSSShorthand.CORNER;
...
import cn.xxzhushou.xmod.wxui.tracing.Stopwatch;
import cn.xxzhushou.xmod.wxui.tracing.WXTracing;
import cn.xxzhushou.xmod.wxui.ui.IFComponentHolder;
import cn.xxzhushou.xmod.wxui.ui.action.BasicComponentData;
import cn.xxzhushou.xmod.wxui.ui.action.GraphicActionAnimation;
import cn.xxzhushou.xmod.wxui.ui.action.GraphicActionUpdateStyle;
import cn.xxzhushou.xmod.wxui.ui.action.GraphicPosition;
import cn.xxzhushou.xmod.wxui.ui.action.GraphicSize;
...
import cn.xxzhushou.xmod.wxui.ui.component.pesudo.TouchActivePseudoListener;
import cn.xxzhushou.xmod.wxui.ui.flat.FlatComponent;
import cn.xxzhushou.xmod.wxui.ui.flat.FlatGUIContext;
import cn.xxzhushou.xmod.wxui.ui.flat.WidgetContainer;
import cn.xxzhushou.xmod.wxui.ui.flat.widget.AndroidViewWidget;
...
import cn.xxzhushou.xmod.wxui.ui.view.gesture.WXGestureType;
import cn.xxzhushou.xmod.wxui.utils.BoxShadowUtil;
import cn.xxzhushou.xmod.wxui.utils.WXDataStructureUtil;
...
//    WXSDKManager.getInstance().getWXDomManager().postAction(getInstanceId(), Actions.getAddEvent(getRef(), type), false);
   ...
   *
   * @param type eventType {@link cn.xxzhushou.xmod.wxui.common.Constants.Event}
